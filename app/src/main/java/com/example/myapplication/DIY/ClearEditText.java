...
public class ClearEditText extends EditText {
    ...
    private void init(Context context, Object o) {
        // 获取自定义属性

        drawableClear = getResources().getDrawable(R.drawable.ic_close);
    ...
    /**
     * 发送editText的长度符合要求的状态     *     * @param s     * @param maxLength
     */
